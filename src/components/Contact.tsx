                                ...
                                {[
                                    ...
                                    <div key={field.id}>
                                        ...
                                        <input
                                            ...
                                            className='w-full px-4 py-3 rounded-lg border bg-white/10 hover:bg-white/20 focus:bg-white/20 border-white/20 focus:border-white/40 focus:outline-none transition-colors text-white'
                                        />
                                    </div>
                                ))}
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className='text-white w-full px-4 py-3 rounded-lg border bg-white/10 hover:bg-white/20 focus:bg-white/20 border-white/20 focus:border-white/40 focus:outline-none transition-colors resize-none'
                                    />
                                </div>
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    type='submit'
                                    className='w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-white/10 bg-white/10 hover:bg-white/20 transition-all text-white'
                                >
