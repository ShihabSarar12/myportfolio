            ...
            >
                <div className='flex items-start gap-4 mb-6'>
                    ...
                    <div className='flex-1'>
                        ...
                        <div className='flex items-start gap-2 mb-2 text-white/70'>
                            ...
                            <p>
                                {formatAuthors(paper.authors, paper.yourName)}
                            </p>
                        </div>
                ...
                <div className='flex flex-wrap gap-2 mb-6'>
                    {paper.tags.map((tag: string) => (
                        <span
                            key={tag}
                            className='px-3 py-1 rounded-full bg-white/0 border border-white/0 text-white/70 hover:bg-white/10 hover:backdrop-blur-md transition-all'
                        >
                            {tag}
                        </span>
                    ))}
                ...
                <div className='flex flex-wrap gap-3 pt-6 border-t border-white/10'>
                    ...
                    <a
                        ...
                        className='ml-auto px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all'
                    >
                        View Details
                    </a>
                </div>
